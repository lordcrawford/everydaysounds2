...
const Home = () => {
    ...
    function openInstructions() {
        document.getElementById("instructions_overlay").classList.remove('hidden');
    }

    return (
        <div id="home" className='h-screen text-white font-museomoderno'>
            <div id="top" className='justify-between flex mt-[1.5%] mt-[3vw]'>
                <h1 className='font-limelight w-[40%] ml-[3%] text-[4vw]' onClick={pageRefresh}>EVERYDAY SOUNDS</h1>
                <nav id="top-nav-right" className='flex flex-col text-[1.5vw] text-right mr-[3vw] mt-[1vw] space-y-[1vw]'>
                    <button id="instructions_button" onClick={openInstructions}>instructions</button>
            ...
            <div>
                <Player/>
                <div id="sequencer" className='text-center mt-[6%]'>
