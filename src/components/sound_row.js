...
class SoundRow extends React.Component {
    ...
    render(){
        ...
        return (
            ...
            md:place-content-center md:p-0 py-[40px] pr-[50px] flex place-items-center">
                <div id='labeling' className='flex select-none'>
                    ...
                    align-middle h-[2.2vw] hover:animate-pulse place-self-center whitespace-nowrap overflow-hidden' style={{borderColor:this.props.color}}> .upload. 💁🏾‍♂️ </label>
                </div>

                <div id={sound_row_steps_id} className="sound_steps space-x-[5vw] md:space-x-[1.2vw] flex">
